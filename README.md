...
| `COMFORT_NOISE_ENABLED` | `true` | Inject low-level comfort noise (~−75 dBFS) into silent mixer frames. Set `false` for cleaner telephony / recording A/B against MediaBridge. |
